...
The current solution uses DuckDB and is suitable for the exercise, but I would change the architecture for a 10TB dataset.
    ...
    •  Upserts – Use a scalable table format such as Delta Lake to efficiently handle inserts and updates rather than repeatedly rewriting large portions of the dataset.
